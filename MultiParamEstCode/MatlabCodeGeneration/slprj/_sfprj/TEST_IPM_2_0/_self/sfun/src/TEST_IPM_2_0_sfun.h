#ifndef __TEST_IPM_2_0_sfun_h__
#define __TEST_IPM_2_0_sfun_h__
...
extern mxArray* load_TEST_IPM_2_0_optimization_info(boolean_T isRtwGen,
  boolean_T isModelRef, boolean_T isExternal);
extern void unload_TEST_IPM_2_0_optimization_info(void);
