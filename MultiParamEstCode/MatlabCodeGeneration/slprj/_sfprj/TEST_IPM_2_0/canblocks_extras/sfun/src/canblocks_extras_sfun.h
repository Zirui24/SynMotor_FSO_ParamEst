#ifndef __canblocks_extras_sfun_h__
#define __canblocks_extras_sfun_h__
...
extern mxArray* load_canblocks_extras_optimization_info(boolean_T isRtwGen,
  boolean_T isModelRef, boolean_T isExternal);
extern void unload_canblocks_extras_optimization_info(void);
